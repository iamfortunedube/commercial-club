...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2156634509ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cc&table=donation">`cc`.`donation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cc&table=claims">`cc`.`claims`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cc&table=allocation">`cc`.`allocation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cc&table=bankss">`cc`.`bankss`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cc&table=transactionhistory">`cc`.`transactionhistory`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cc&table=referals">`cc`.`referals`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cc&table=support">`cc`.`support`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cc&table=users">`cc`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cc&table=admin">`cc`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=testcake&table=users">`testcake`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7b48593e7c4c47665371716b37555f4d">
